                                        ...
                                        <fieldset>
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <input class="form-control" id="rolename"
                                                           placeholder="请输入角色名称最多10个字"
                                                           name="role.name"
                                                           type="text" placeholder="请输入角色名称！" value="${vrole.role.name}"
                                                           class="required">
                                                    <input name="role.id" id="cid" type="hidden"
                                                           value="${vrole.role.id}"/>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    ...
                                                    <%--弹出层结束--%>
                                                    <button type="button" id="editbt" class="btn btn-primary">修改权限
                                                    </button>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <%--新的弹出层开始--%>
                                                    <div class="modal fade bs-example-modal-lg" id="oModal"
                                                         tabindex="-1"
                                                         role="dialog" aria-labelledby="myLargeModalLabel"
                                                         aria-hidden="true">
                                                        <div class="modal-dialog modal-lg">
                                                    ...
                                                    <span id="offnames">${vrole.offnames}</span> <input
                                                        type="hidden" name="offids" id="offids"
                                                        value="${vrole.offids}"/>
                                                </div>
                                            </div>
                                            <div class="form-group">
